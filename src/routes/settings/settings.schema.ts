 ...
 */
export const surgePricing = pgTable(
  'surge_pricing',
  {
  ...
  (table) => [index('surge_pricing_location_idx').on(table.centerLat, table.centerLng), index('surge_pricing_time_range_idx').on(table.startTime, table.endTime)]
);
